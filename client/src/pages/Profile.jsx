...
import { uploadImageToCloudinary } from "../utlis/uploadImage.js";
import {
  updateUserStart,
  updateUserSuccess,
  updateUserFailure,
...
export default function Profile() {
  ...
  setFilePerc(0);
  try {
    const downloadURL = await uploadImageToCloudinary(file, (percent) => {
      setFilePerc(percent);
    });
  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          disabled={loading}
          className="bg-slate-700 cursor-pointer text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80"
        >
